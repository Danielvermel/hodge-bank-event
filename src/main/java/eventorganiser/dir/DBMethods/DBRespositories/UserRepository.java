...
public class UserRepository {
    ...
    public static Integer getUserIdFromUsername(String username) throws DataAccessException {
    ...
    public List<User> getUserDetailsFromId(String userId) throws DataAccessException {
        ...
        return jdbcTemplate.query(str, new Object[]{},
                (rs, i) -> new User(rs.getInt("userId"),
                        rs.getString("username"),rs.getString("password"), rs.getString("cPassword"), rs.getString("firstName"),
    ...
    public User getRandomUser()throws DataAccessException {
        ...
        List<User> usrLi = jdbcTemplate.query(str, new Object[]{},
                (rs, i) -> new User(rs.getInt("userId"), rs.getString("username"), rs.getString("password"), rs.getString("cPassword"),
                        rs.getString("firstName"), rs.getString("lastName") ) );
        return usrLi.get(0);
    }
